...
INSERT INTO WAITER (MAIL,PASSWORD,FIRSTNAME,LASTNAME,REGISTRATED,CLOTHES_SIZE,SHOES_SIZE,RESTAURANT_RESTAURANT_ID) VALUES ('9','9','milanko','milanovic','1','M','no45',1)

INSERT INTO COOK (MAIL,PASSWORD,FIRSTNAME,LASTNAME,REGISTRATED,CLOTHES_SIZE,SHOES_SIZE,RESTAURANT_ID) VALUES ('8','8','milance','milanovic','1','M','no46',1)

INSERT INTO BARTENDER (MAIL,PASSWORD,FIRSTNAME,LASTNAME,REGISTRATED,CLOTHES_SIZE,SHOES_SIZE,RESTAURANT_RESTAURANT_ID) VALUES ('a@gmail.com','a','milan','milanovic','1','M','no45',1)
INSERT INTO BARTENDER (MAIL,PASSWORD,FIRSTNAME,LASTNAME,REGISTRATED,CLOTHES_SIZE,SHOES_SIZE,RESTAURANT_RESTAURANT_ID) VALUES ('saAA@ss','passw','milan','milanovic','1','M','no45',1)
